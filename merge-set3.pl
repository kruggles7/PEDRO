...
#FILE1 
my $file="2.17.15_081814FinalPart1_2015_02_17_11_07_39 (1).txt";
my %file1=();
open (IN, "$file") or die "can't open file";
my $line=<IN>;
chomp ($line);
...
$file="2.17.15_081814FinalPart2_2015_02_17_17_52_13.txt";
my %file2=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
$file="2.17.15_081814FinalPart3_2015_02_17_17_54_45.txt";
my %file3=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
$file="2.17.15_081814FinalPart4_2015_02_17_17_55_28.txt";
my %file4=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
open (OUT, ">Pedro_merge_set3.txt") or die "can't open file";
#print labels
print OUT "ID\t";
