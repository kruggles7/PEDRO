...
while ($line=<IN>)
{
    ...
    elsif ($line=~/\w/) {print "error parsing $line\n in file SCREENING\n";}
}
close IN;
...
#FILE1 
$file="6.26.2015081814FinalPart1_2015_06_26_17_35_06-1.txt";
my %file1=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
$file="6.26.2015081814FinalPart2_2015_06_26_18_21_13.txt";
my %file2=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
$file="6.26.2015081814FinalPart3_2015_06_26_18_24_17.txt";
my %file3=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
$file="6.26.2015081814FinalPart4_2015_06_26_18_24_48.txt";
my %file4=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
$file="6.26.2015081814FinalPart5_2015_06_26_18_19_18.txt";
my %file5=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
open (OUT, ">Pedro_merge_set6.txt") or die "can't open file";
#print labels
print OUT "ID\t";
...
my @file5_label=split('\t',$file5_label);
$n=scalar(@file5_label); 
for (my $i=0; $i<$n; $i++)
{
    print OUT "$file5_label[$i]\t";
    $c10++; 
}
print OUT "\n";
