...
#FILE1 
$file="1.8.15_081814FinalPart1_2015_01_08_11_46_54.txt";
my %file1=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
$file="1.8.2015_081814FinalPart2_2015_01_08_11_47_46.txt";
my %file2=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
$file="1.8.2015_081814FinalPart3_2015_01_08_11_48_57.txt";
my %file3=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
$file="1.8.2015_081814FinalPart4_2015_01_08_12_13_51.txt";
my %file4=();
open (IN, "$file") or die "can't open file";
$line=<IN>;
chomp ($line);
...
open (OUT, ">Pedro_merge_set1.txt") or die "can't open file";
##print labels
print OUT "ID\t";
